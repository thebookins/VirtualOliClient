...
final class VirtualPumpSettingsSetupViewController: SetupTableViewController {
    
    var pumpManager: VirtualPumpManager?
    
    private var pumpManagerSetupViewController: VirtualPumpSetupViewController? {
        return navigationController as? VirtualPumpSetupViewController
    }
...
extension VirtualPumpSettingsSetupViewController: DailyValueScheduleTableViewControllerDelegate {
...
extension VirtualPumpSettingsSetupViewController: DeliveryLimitSettingsTableViewControllerDelegate {
